...
export class Comment {
  constructor(data) {
    ...
    this.commentHotCount = data.commentHotCount
  ...
  get CommentTemplate() {
    ...
    <div class="d-flex justify-content-between align-items-center border-top border-dark p-2">
      ...
      <div class="d-flex flex-column justify-content-between">
        ${this.ComputedUpdate}
        <div onclick="app.CommentHotsController.checkCommentHotByComment('${this.id}')" class="d-flex align-items-center p-2 selectable" title="That's Hot">
          <p>${this.commentHotCount}</p>
  ...
  get ComputedUpdate() {
    ...
    return /*HTML*/`
    <button onclick="app.CommentsController.removeComment('${this.id}')" class="btn text-white" type="button" title="Delete Post">
